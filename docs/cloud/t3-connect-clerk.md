...
T3CODE_PORT=13773 \
  "/Applications/Command Center (Alpha).app/Contents/MacOS/Command Center (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Command Center (Alpha).app"
codesign -d --entitlements :- "/Applications/Command Center (Alpha).app"
```
