  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Command Center prerelease is available for nightly testers."
          : "A new Command Center latest release is available.",
...
).pipe(Command.withDescription("Post a Command Center release announcement to Discord."));
