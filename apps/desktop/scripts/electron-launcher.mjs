// This file mostly exists because we want dev mode to say "Command Center (Dev)" instead of "electron"
...
function buildMacLauncher(electronBinaryPath) {
  ...
  if (isDevelopment) {
    ...
    // Electron.app even though this bundle's Info.plist has the Command Center name.
