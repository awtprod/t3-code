...
import * as GoogleReadConnector from "../src/command-center/GoogleReadConnector.ts";
import * as CommandCenterReadinessGate from "../src/command-center/ReadinessGate.ts";
...
const startupDependencies = Layer.mergeAll(
  ...
  // Command Center's startup gate pulls in services upstream's copy of this
  // test never had to provide. Empty mocks keep the recovery path under test
