...
>()("@awtprod/command-center/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Command Center could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Command Center still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
