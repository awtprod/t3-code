...
/**
 * Managed repository projects are direct children of the runtime repository
 * directory. Keeping this check deliberately narrow prevents Command Center
 * routes from adopting an otherwise-matching T3 project elsewhere on the host.
 */
