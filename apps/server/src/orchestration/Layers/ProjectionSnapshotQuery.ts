...
function mapThreadActivityRow(
  ...
  return {
    ...
    turnId: row.turnId,
    createdAt: row.createdAt,
    ...(row.correlatedMessageId !== null ? { correlatedMessageId: row.correlatedMessageId } : {}),
    ...
    execute: ({ threadId }) =>
      sql`
        ...
        SELECT
          ...
          activity.correlated_message_id AS "correlatedMessageId",
          activity.tone,
          activity.kind,
          activity.summary,
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                routingMode: row.routingMode ?? "manual",
                ...(row.efficiencyTier == null ? {} : { efficiencyTier: row.efficiencyTier }),
                runtimeMode: row.runtimeMode,
