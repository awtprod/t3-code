...
function SidebarControl() {
  ...
  return (
    ...
    <div
      className="pointer-events-none fixed left-[var(--workspace-controls-left)] top-[calc(var(--desktop-titlebar-clearance)+var(--workspace-controls-top))] z-50 ml-px flex h-[var(--workspace-topbar-height)] items-center"
