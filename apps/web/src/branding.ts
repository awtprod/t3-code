...
export const HOSTED_APP_CHANNEL_SWITCHING_ENABLED =
  import.meta.env.VITE_HOSTED_APP_CHANNEL_SWITCHING === "1";
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "Command Center";
